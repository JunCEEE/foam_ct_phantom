...
# gen h5 dataset w/ projected thicknesses of cylinder & bubbles
def gen_dataset(outfile, phantom, geom):
    ...
    with h5py.File(outfile, 'w') as f:
        f.attrs['FILE_VERSION'] = FILE_VERSION
        dset = f.create_dataset('projs', (len(angles),2,ny,nx), dtype='f4')    # two projected arrays, cylinder and bubbles 
